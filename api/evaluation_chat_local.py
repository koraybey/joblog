...
index = VectorStoreIndex.from_documents(vacancy_data)
...
chat_engine = index.as_chat_engine(
    ...
    system_prompt=(
        """\
        You are an expert human resources manager, helping candidates get an interview by improving their resume to match the job requirements and responsibilities.
        ...
        is_match: Determine if the text matches the job requirements and responsibilities.
...
response = chat_engine.stream_chat(
    "Supervised the development, repository maintenance, and management of over a hundred React-based Chrome homepage extensions for prestigious brands, including Fenerbahçe, Galatasaray, AC Milan, Red Bull, Manchester City, Aston Villa, and Universal Music."
)
